AZdecrypt can use 2, 3, 4, 5, 6, 8 and 10 letter n-grams with most of its solvers. By default AZdecrypt uses 5-grams. To use another n-gram size click on File and then click Load letter n-grams.
